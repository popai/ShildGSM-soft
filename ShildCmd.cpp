...
const prog_char IN1[] PROGMEM = "IN1";			//address 18*1
const prog_char IN2[] PROGMEM = "IN2";			//address 18*2
const prog_char IN3[] PROGMEM = "IN3";			//address 18*3
const prog_char OUT1L[] PROGMEM = "OUT1L";		//address 18*4
const prog_char OUT1H[] PROGMEM = "OUT1H";		//address 18*5
const prog_char OUT1P[] PROGMEM = "OUT1P";		//address 18*6
const prog_char OUT2L[] PROGMEM = "OUT2L";		//address 18*7
const prog_char OUT2H[] PROGMEM = "OUT2H";		//address 18*8
const prog_char OUT2P[] PROGMEM = "OUT2P";		//address 18*9
const prog_char OUT3L[] PROGMEM = "OUT3L";		//address 18*10
const prog_char OUT3H[] PROGMEM = "OUT3H";		//address 18*11
const prog_char OUT3P[] PROGMEM = "OUT3P";		//address 18*12
const prog_char OUT4L[] PROGMEM = "OUT4L";		//address 18*13
const prog_char OUT4H[] PROGMEM = "OUT4H";		//address 18*14
const prog_char OUT4P[] PROGMEM = "OUT4P";		//address 18*15
const prog_char OUT5L[] PROGMEM = "OUT5L";		//address 18*16
const prog_char OUT5H[] PROGMEM = "OUT5H";		//address 18*17
const prog_char OUT5P[] PROGMEM = "OUT5P";		//address 18*18
const prog_char OUT6L[] PROGMEM = "OUT6L";		//address 18*19
const prog_char OUT6H[] PROGMEM = "OUT6H";		//address 18*20
const prog_char OUT6P[] PROGMEM = "OUT6P";		//address 18*21
const prog_char TMP1[] PROGMEM = "TMP1";		//address 18*22
const prog_char TMP2[] PROGMEM = "TMP2";		//address 18*23
const prog_char PASS[] PROGMEM = "PASS";		//address 18*24
const prog_char LOGIN[] PROGMEM = "LOGIN";		//predefined command
const prog_char DEL[] PROGMEM = "DEL";			//predefined command
const prog_char DELEP[] PROGMEM = "DELEP";		//predefined command
